...
export const FiltersLabel = styled.b`
  font-weight: 400;
  font-size: 14px;
  line-height: 140%;
  color: #111827;
...
export const FilterUl = styled.ul<{ $visible?: boolean }>`
  width: 272px;
  position: absolute;
  z-index: 1000;
  background-color: #ffffff;
...
export const FilterLi = styled.li<{ $active: boolean }>`
  min-height: 26px;
...
export const FilterArrow = styled.svg<{ $visible: boolean }>`
  width: 20px;
  height: 20px;
  position: absolute;
  top: 9px;
